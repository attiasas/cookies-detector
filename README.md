...
- Built-in methods: **Base64**, **URL decode**, **JSON (pretty)**, **Hex to UTF-8**, **UTF-8 bytes to string**, **JWT**, **Unix timestamp**, **Base64 → Hex**. New decoders can be added easily in code.
